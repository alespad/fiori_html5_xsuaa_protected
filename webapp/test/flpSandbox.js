		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Protected App",
									"targetURL": "#testprotectedapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testprotectedapp-display": {
								"semanticObject": "testprotectedapp",
								"action": "display",
								"description": "An SAP Fiori protected application.",
								"title": "Protected App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testprotectedapp",
									"url": sap.ui.require.toUrl("testprotectedapp")
								}
							}
						}
					}
